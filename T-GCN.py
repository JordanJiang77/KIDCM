...
adj = pd.read_excel(r'E:\I-24motiondata/dataset/adjdemo.xlsx')
data = np.array(data)
adj = np.array(adj)
...
# weight1 = sess.run(weights)
# biases1 = sess.run(biases)
# weight1 = weight1['out']
# biases1 = biases1['out']
# weights = np.array([weight1])
# biases1 = np.array([biases1])
# weights = weights.reshape(-1, 1)
# biases1 = biases1.reshape(-1, 1)
#
# print(weight1.shape)
# print(biases1.shape)
#
# df1 = pd.DataFrame(weights)
# df2 = pd.DataFrame(biases1)
# #
# df1.to_excel('weight5.xlsx', index=False)
# df2.to_excel('biases5.xlsx', index=False)

df1 = pd.DataFrame(test_result)
df2 = pd.DataFrame(test_label1)

df1.to_excel('TGCNFpre.xlsx', index=False)
df2.to_excel('TGCNFrea.xlsx', index=False)